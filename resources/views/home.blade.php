			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						<h3><span class="orange-text">اقسام الموقع</h3>
						<p>خدمه في اي مكان في مصر</p>
					</div>
				</div>
	            <div class="row">
            @foreach ($categories as $item)
                        ...
                        <div class="single-product-item">
                            <div class="product-image">
                                    <a href="/products"><img src="{{asset($item->imagepath)}}" alt=""
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							...
							<p class="excerpt">Vivamus lacus enim, pulvinar vel nulla sed, scelerisque rhoncus nisi. Praesent vitae mattis nunc, egestas viverra eros.</p>
							<a href="/single_news" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							<h3><a href="/single_news=">Good thoughts bear good fresh juicy fruit.</a></h3>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> Admin</span>
								<span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
							</p>
